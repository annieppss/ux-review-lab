...
> 지난 스킬 만들기 과제로 시작한 **원하는재료로 AI 전담셰프 만들기**를 제작하면서, 앱을 만들기 위해 화면 제작중, 화면의 시각적 주목도를 점검한 실제 예시입니다. 실제 사용자의 시선을 측정한 결과가 아니라 화면의 크기, 대비, 색상, 위치와 정보 위계를 바탕으로 AI가 예상한 주목도입니다.
